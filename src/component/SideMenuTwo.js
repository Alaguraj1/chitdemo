          ...
          <div className="wrapper sidemenu-main">
            ...
            <div className="socialmedia-outer">
                ...
                <ul>
                  <li className="mr-[8px] inline-block">
                    <a
                      className="text-[#333]"
                      target="_blank"
                      href="https://www.facebook.com/sreethangamjewellry"
                    >
                      <img
                        className="svg"
                  ...
                  <li className="mr-[8px] inline-block">
                    <a
                      className="text-[#333]"
                      target="_blank"
                      href="https://twitter.com/sree_thangam"
                    >
                      <img
                        className="svg"
                  ...
                  <li className="mr-[8px] inline-block">
                    <a
                      className="text-[#333]"
                      target="_blank"
                      href="https://www.instagram.com/sree_thangam_jewellery/"
                    >
                      <img
                        className="svg"
              ...
              <div className="copyright w-full float-left">
                ...
                Concept by{" "}
                <Link to="https://irepute.in/" target="blank">
                  repute.
                </Link>
              </div>
            </div>
              ...
              <ul>
                ...
                <li className="mr-[3px] inline-block">
                  <a
                    ...
                    target="_blank"
                  >
                    <i className="icon-instagram-1 absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] text-[16px]"></i>
                  </a>
                </li>
              </ul>
            </div>
